...
-- Assignment 2 - Query 4: Modify "GM Hummer" record to change "small interiors" to "a huge interior"
UPDATE public.inventory 
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior') 
WHERE inv_make = 'GM' AND inv_model = 'Hummer';


-- Assignment 2 - Query 6: Update all inventory records to add "/vehicles" to the middle of file paths
UPDATE public.inventory 
